...
// v6: v5 plus padded threadgroup tiles.
// The extra column changes shared-memory stride while keeping the same math.
kernel void sgemm_microtile_2d_vec4_padded(const device float *A [[buffer(0)]],

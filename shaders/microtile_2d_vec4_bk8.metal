...
// BK=8 sweep variant of the v5 Vec4 kernel.
// Half the threads participate in tile loads because each tile has 512 floats.
kernel void sgemm_microtile_2d_vec4_bk8(const device float *A [[buffer(0)]],
